...
ui <- fluidPage(tags$head(HTML("<title>ATLANTIS</title> <link rel='icon' type='image/gif/png' href='favicon.png'>")),
                ...
                navbarPage(strong('ATLANTIS'),
                           navbarMenu('Home',
                                      ...
                                      tabPanel('Tasks', 
                                               selectInput(inputId = 'tasksSelectProject', label = 'Project', choices = queryTasksSelectProject()),
                                               br(),
                                      ...
                                      tabPanel('Issues',
                                               selectInput(inputId = 'issuesSelectProject', label = "Project", choices = queryIssuesSelectProject()),
                                               br(),
